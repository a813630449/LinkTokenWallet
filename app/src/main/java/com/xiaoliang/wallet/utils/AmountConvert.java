...
public class AmountConvert {
    public static BigDecimal fromWei(String hexNumber, Unit unit) {
        hexNumber = new BigInteger(hexNumber.replace("0x", ""), 16).toString();
        return fromWei(new BigDecimal(hexNumber), unit);
    }
