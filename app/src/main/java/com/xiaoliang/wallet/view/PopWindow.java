...
public class PopWindow extends PopupWindow{
	...
	public PopWindow(final Activity context){
		...
		conentView.findViewById(R.id.importaccount).setOnClickListener(new OnClickListener() {
		...
		conentView.findViewById(R.id.joingroup).setOnClickListener(new OnClickListener() {
					
			@Override
			public void onClick(View arg0) {
				// do something before signing out
				joinQQGroup("y_eVbqeyx1ELK2fC6CtQFgqBqkZ8mWMI",context);
				PopWindow.this.dismiss();
			}
		});
	}
