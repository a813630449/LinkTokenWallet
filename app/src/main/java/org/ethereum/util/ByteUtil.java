...
public class ByteUtil {
    ...
    /**
     * The regular {@link BigInteger#toByteArray()} method isn't quite
     ...
     * <br>
     * Instead of
     * {@link org.spongycastle.util.BigIntegers#asUnsignedByteArray(BigInteger)} <br>
	...
	return new byte[] { (byte) ((msgLen >> 24) & 0xFF), (byte) ((msgLen >> 16) & 0xFF), (byte) ((msgLen >> 8) & 0xFF),
	        (byte) ((msgLen) & 0xFF) };
    }
